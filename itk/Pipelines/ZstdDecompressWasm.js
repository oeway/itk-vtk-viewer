var ZstdDecompress = (function() {
  var _scriptDir =
    typeof document !== 'undefined' && document.currentScript
      ? document.currentScript.src
      : undefined
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename
  return function(ZstdDecompress) {
    ZstdDecompress = ZstdDecompress || {}

    var Module = typeof ZstdDecompress !== 'undefined' ? ZstdDecompress : {}
    Module['locateFile'] = function(fileName, prefix) {
      if (fileName === 'ZstdDecompressWasm.wasm') {
        if (ZstdDecompress.isAbsoluteURL) {
          return ZstdDecompress.pipelinePath + 'Wasm.wasm'
        }
        if (typeof ZstdDecompress.moduleScriptDir !== 'undefined') {
          return ZstdDecompress.moduleScriptDir + '/ZstdDecompressWasm.wasm'
        }
        return prefix + '../Pipelines/ZstdDecompressWasm.wasm'
      }
    ...
    var wasmBinaryFile = 'ZstdDecompressWasm.wasm'
...
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = ZstdDecompress
else if (typeof define === 'function' && define['amd'])
  define([], function() {
    return ZstdDecompress
  })
else if (typeof exports === 'object') exports['ZstdDecompress'] = ZstdDecompress
